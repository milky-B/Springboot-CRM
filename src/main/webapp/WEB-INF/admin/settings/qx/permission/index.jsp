			...
			$.ajax({
				...
				success: function (responseText) {
					...
					$.each(responseText.data, function (index, object) {
						...
						html+="<td>"+index+"</td>";
						html+="<td><a href=\"javascript:void(0);\" style=\"text-decoration: none;\">"+object.name+"</a></td>";
						html+="<td>"+object.parentName+"</td>";
						html+="<td>"+object.path+"</td></tr>";
						html+="<td>"+object.icon+"</td></tr>";
						html+="<td>"+object.perms+"</td></tr>";
					});
					console.log(html);
					$("#enumForm").html(html);
					let total = 1;
